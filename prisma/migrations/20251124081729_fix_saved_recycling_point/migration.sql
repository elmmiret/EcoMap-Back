/*
  ...
  - Added the required column `client_id` to the `publication` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "publication" ADD COLUMN     "client_id" TEXT NOT NULL;
...
-- AddForeignKey
ALTER TABLE "publication" ADD CONSTRAINT "publication_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "client"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION;
